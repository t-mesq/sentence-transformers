...
class InformationRetrievalTemperatureDataset(IterableDataset):
    def __init__(self, model, queries, corpus, rel_queries, rel_corpus, negatives_weighter, temperature=1, batch_size=32, shuffle=True, n_negatives=1, neg_rel_queries=None):
        self.model = model
    ...
    def __iter__(self):
        ...
        for i in range(self.__len__()):
            ...
            d_mask = self.neg_rel_queries.index != d_id
